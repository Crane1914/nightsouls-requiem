...
public class PetrifiedHeavenstone extends Block {
	
	BlockPos requiemBlockPos = new BlockPos(0,0,0);

	public PetrifiedHeavenstone(Properties properties) {
		super(properties);
	}
	...
	public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
		...
		if(worldIn.getWorldBorder().getSize() == NightSoulsKey.requiemWBSize)
		   {	
			  worldIn.setBlockState(pos, BlockInit.HEAVENSTONE.get().getDefaultState());
   	       }
