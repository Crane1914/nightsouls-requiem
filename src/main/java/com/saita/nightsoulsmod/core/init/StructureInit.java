...
import com.saita.nightsoulsmod.common.world.structures.NightSoulsCampStructure;
...
public class StructureInit {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> NIGHTSOULS_CAMP =
            STRUCTURES.register("nightsouls_camp", NightSoulsCampStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(NIGHTSOULS_CAMP.get(),
                new StructureSeparationSettings(StructuresConstants.commonMax, StructuresConstants.commonMin, 134218728),
                true);
    }
